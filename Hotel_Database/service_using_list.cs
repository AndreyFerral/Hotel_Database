...
{
    public partial class service_using_list : Form
    {
        SqlConnection myConn = new SqlConnection();
        int indexSelectRow;
        string nameService, dateService, idАrrival, usageCount;

        public service_using_list()
        {
            InitializeComponent();
        }
        ...
        private void info_ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                service_using_information form10 = new service_using_information(nameService, dateService, idАrrival, usageCount);
                form10.ShowDialog();
            }
            catch
            {
